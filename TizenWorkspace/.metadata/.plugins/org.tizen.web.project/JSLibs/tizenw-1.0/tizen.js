...
and the <a href=" http://127.0.0.1:53283/help/topic/org.tizen.web.appprogramming/html/guide/app_guide/application_service.htm">application control </a>information if it is necessary. 
For more information about the application contorl, see <a href="http://127.0.0.1:53283/help/topic/org.tizen.web.device.apireference/tizen/application.html">The Application API</a>.
            </p>
...
For more information on the Alarm features, see <a href="http://127.0.0.1:53283/help/topic/org.tizen.web.appprogramming/html/guide/app_guide/alarm.htm">Alarm Guide</a>.
        </p>
 *
 * @type AlarmManager
 */
 ...
 * <p>
For more information on the Application features, see <a href="http://127.0.0.1:53283/help/topic/org.tizen.web.appprogramming/html/guide/app_guide/application.htm">Application Guide</a>.
        </p>
 *
 ...
 * @type Number
 */
CameraError.FILE_WRITE_ERR = new Number();
 ...
 * <p>
For more information on the Content features, see <a href="http://127.0.0.1:53283/help/topic/org.tizen.web.appprogramming\html\guide\content_guide\mediacontent.htm">Content Guide</a>.
        </p>
 *
 * @type ContentManager
 */
...
<a href="http://127.0.0.1:53283/help/topic/org.tizen.web.device.apireference/tizen/tizen.html#::Tizen::AbstractFilter">Tizen</a> module. The filter allows precise searching such
 ...
 * <p>
For more information on the Filesystem features, see <a href="http://127.0.0.1:53283/help/topic/org.tizen.web.appprogramming/html/guide/io_guide/filesystem.htm">File System Guide</a>.
        </p>
 *
...
The ErrorCallback is launched with these error types:
            ...
            <ul>
              <li>
UnknownError: If an error occurs while sending data.              </li>
              <li>
 ...
 * @type IrLedManager
 */
WebAPIs.prototype.irled = new IrLedManager();
...
/**
 * The MotionManagerObject interface defines what is instantiated by the object. The object allows access to the motion data.
 *
 * @super Object
 * @constructor
...
The ErrorCallback is launched with these error types:
            ...
            <ul>
              <li>
 ServiceNotAvailableError : If the getMotionInfo method is called without calling the start method with PEDOMETER.              </li>
            </ul>
 ...
 * <p>
For more information on the Power features, see <a href="http://127.0.0.1:53283/help/topic/org.tizen.web.appprogramming/html/guide/sys_guide/power.htm">Power Guide</a>.
        </p>
 *
 * @type PowerManager
 */
 ...
 * Defines what is instantiated in the webapis object.
          <p>
There is a webapis.sa object that allows accessing the
 ...
 * @super Object
 * @constructor
 * @return {SAAuthenticationToken}
 */
function SAAuthenticationToken() {};
SAAuthenticationToken.prototype = new Object();
 ...
 * This callback function is invoked when authentication information of remote peer are successfully returned.
          <p>
Application can verify remote peer agent's identity by checking its authentication token information, then decide whether to request a service connection with the remote peer agent,
or whether to accept incoming service connection requests from the remote peer agent.
          </p>
         
 *
 * @super Object
 * @constructor
 * @return {SAAuthenticatePeerAgentSuccessCallback}
 */
function SAAuthenticatePeerAgentSuccessCallback() {};
SAAuthenticatePeerAgentSuccessCallback.prototype = new Object();
...
The application is notified of the result of a Service Connection request
via the ServiceConnectionCallback registered by setServiceConnectionListener(), which reports whether the request is accepted and a Service Connection is
established, or the request for a Service Connection did not succeed.
            </p>
            <p>
The application is expected to ensure the availability of the Accessory Peer Agent before calling this method.
 ...
 * Sets a listener to get both a connection request and connection establish event.
            <ul>
              <li>
The onconnect() method of ServiceConnectionCallback is invoked when a connection between a Service Provider and Service Consumer application is established.              </li>
              <li>
The onrequest() method of ServiceConnectionCallback is invoked when a remote Accessory Peer Agent requests for a Service Connection with this application.              </li>
              <li>
...
The ErrorCallback is launched with these error types:
            ...
            <ul>
              <li>
TokenNotGeneratedError : if the authentication token of remote peer agent is not generated.              </li>
            </ul>
           
 *
 * @param {SAPeerAgent} peerAgent
 * @param {SAAuthenticatePeerAgentSuccessCallback} successCallback
 * @param {ErrorCallback} errorCallback
 * @type void
 * @memberOf SAAgent
 * @returns {void}
 */
SAAgent.prototype.authenticatePeerAgent = function(peerAgent, successCallback, errorCallback){ return; };
 ...
 * Finds a matching Accessory Peer Agent.
            <p>
This method starts finding matching Accessory Peer Agents. If any matching Accessory Peer Agent is found, the application notifies via the onpeeragentfound callback that is registered by the setPeerAgentFindListener function.
If multiple matching Accessory Peer Agents are found, the callback is invoked multiple times, once for each matching Accessory Peer Agent.
            </p>
 ...
 * Sets a listener to set the found remote Accessory Peer Agents.
            <ul>
              <li>
The onpeeragentfound() method of SAPeerAgentFindCallback is invoked when a remote Accessory Peer Agent is found.              </li>
              <li>
The onpeeragentupdated() method of SAPeerAgentFindCallback is invoked to notify an application of a change in the status of a peer agent on a remote device.              </li>
              <li>
The onerror() method of SAPeerAgentFindCallback is invoked when an error occurs while finding a remote Accessory Peer Agent.              </li>
            </ul>
...
/**
 * Cancels an ongoing file transfer. This may be called by the sender or receiver of the file.This API is available for both the sender and receiver side.
 *
 * @param {TransferId} id
 * @type void
 * @memberOf SAFileTransfer
 ...
 * <ul>
 * <li>: An Accessory Service Profile defines the roles of a Service Provider and Service Consumer, and specifies the formats for application level protocol messages and message sequences between a Service Consumer and Service Provider.
 ...
 * <li>: An Accessory Peer Agent is the main interface between the Accessory Service Framework and a Service Provider or Service Consumer. From the perspective of the Accessory Service Framework, Service Providers and Service Consumers are considered as Accessory Peer Agents.
...
The ErrorCallback is launched with these error types:
            ...
            <ul>
              <li>
ServiceNotAvailableError : If the Accessory Agent registration fails.              </li>
            </ul>
 ...
 * Invoked when a remote Accessory Peer Agent requests for a Service Connection with an application.
            <p>
Application calls SAAgent.acceptServiceConnectionRequest() in this callback to accept a Service Connection request,
or calls SAAgent.rejectServiceConnectionRequest() to reject it.
            </p>
 ...
 * Sends sting data to a remote Accessory Peer Agent.
            <p>
Sends a string to the specified Service Channel. The string must not be longer than the value of the <em>maxAllowedDataSize</em> attribute in the SAPeerAgent interface.
            </p>
 ...
 * Sends encrypted sting data to a remote Accessory Peer Agent.
            <p>
Sends an encrypted string to the specified Service Channel. The string must not be longer than value of the <em>maxAllowedDataSize</em> attribute in the SAPeerAgent interface.
            </p>
...
For example:
            ...
            <ul>
              <li>
The Accessory Device went out of the range of the wireless connectivity.              </li>
              <li>
The Accessory Peer Agent terminated the Service Connection.              </li>
              <li>
An error occurred which resulted in the Service Connection being terminated.              </li>
            </ul>
            <p>
The reason for the Service Connection being lost is indicated via the errorCode. <br/>            </p>
            <p>
 ...
 */
SAAuthenticationToken.prototype.authenticationType = new AuthenticationType();
 ...
 * @type String
 */
SAAuthenticationToken.prototype.key = new String();
 ...
 *
 * @param {SAPeerAgent} peerAgent
 * @param {SAAuthenticationToken} authToken
 * @type void
 * @memberOf SAAuthenticatePeerAgentSuccessCallback
 * @returns {void}
 */
SAAuthenticatePeerAgentSuccessCallback.prototype.onsuccess = function(peerAgent, authToken){ return; };
 ...
 * </ul>
 * <p>
For more information on the SystemInfo features, see <a href="http://127.0.0.1:53283/help/topic/org.tizen.web.appprogramming/html/guide/sys_guide/systeminfo.htm">System Information Guide</a>.
        </p>
 *
 * @type SystemInfo
 */
 ...
 * <p>
For more information on the Time features, see <a href="http://127.0.0.1:53283/help/topic/org.tizen.web.appprogramming/html/guide/sys_guide/time.htm">Time Guide</a>. 
        </p>
 *
 * @type TimeUtil
 */
 ...
 * </ul>
 * <p>
For other possible values for this attribute, see the values defined in <a href="http://www.w3.ohttp://127.0.0.1:53283/help/topic/dom/#error-types">DOM error types</a> 
            </p>
 *
 * @type String
 */
 ...
 * <p>
For more information on the Tizen features, see <a href="http://127.0.0.1:53283/help/topic/org.tizen.web.appprogramming/html/guide/tizen_guide/tizen.htm">Tizen Guide</a>.  
        </p>
 *
 * @type Tizen
 */
...
Possible values are the ones defined in <a href="http://www.w3.ohttp://127.0.0.1:53283/help/topic/dom/#error-types">DOM error types</a>. 
            </p>
 * <p>
