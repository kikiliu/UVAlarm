    ...
    def: function viewsPageRegister(req) {
        ...
        function updateTemporaryDistance(distance) {
            ...
            if (elTotalUV == null){
            	...
            	elTotalUV = elTotalUV+distance;
            }
            updateDistance(elTotalUV.toFixed(1));
        }
        ...
        function onStop(ev) {
            ...
            // Avoid going into save record process
            //stop(false);
        }
        ...
        function onPedometerInfoChange(param) {
            ...
            // Modified Updating Current UV
            // updateSteps(pedometerInfo.totalStep);      
            updateSteps(pedometerInfo.speed);
            updateTemporaryDistance(pedometerInfo.speed);            
